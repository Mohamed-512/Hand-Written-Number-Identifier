...
# Specifying openCV to use the first camera in the system
camera = cv2.VideoCapture(0)
# Load a model
model = models.load_model('mnist_model_epoch12_5000imgs.h5')
...
"""
Here the camera frame is captured infinitely and processed 
"""
while True:
    # Capturing frame
    ...
    # Refreshing OpenCV buffer
    if cv2.waitKey(1) & 0xFF == ord('q'):
        break

# Releasing access to camera
camera.release()
# Destroying any window opened from openCV in this script i.e. 'frame0'
